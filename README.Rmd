...
The package supports three `re_cov` modes. They specify how the random-effects vector $\alpha$ is assumed to covary — **not** what $Z$'s entries look like. The distribution of $Z$ (binary indicators, continuous values, or a mix) doesn't enter the choice; only the structure of $\alpha$ does.
